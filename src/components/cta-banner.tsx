    ...
    <section className="py-16">
      <div className="container">
        <div className="mesh-panel overflow-hidden rounded-[2rem] border border-cyan-300/20 bg-slate-950 px-8 py-10 text-slate-50 shadow-glow sm:px-12 sm:py-14 dark:border-cyan-300/15">
          ...
          <p className="text-sm uppercase tracking-[0.2em] text-cyan-100/80">Open to engineering conversations</p>
          <div className="mt-4 flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl space-y-3">
              <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">Hiring for a full stack or backend-leaning role?</h2>
              <p className="text-slate-200/80">I&apos;m happy to connect about software engineering opportunities, product work, or a closer look at my experience.</p>
            </div>
